  ...
  return {
    ...
    classes: {
      ...
      panelSoft: isDark
        ...
        : 'border border-slate-200/80 bg-[linear-gradient(135deg,_rgba(239,246,255,0.96),_rgba(255,255,255,0.98))] shadow-[0_18px_45px_rgba(148,163,184,0.12)]',
      surface: isDark
      ...
      surfaceAccent: isDark
        ...
        : 'bg-[linear-gradient(135deg,_#eff6ff_0%,_#ffffff_55%,_#f0f9ff_100%)]',
      darkTile: isDark
      ...
      label: isDark ? 'text-sky-300' : 'text-sky-700',
      labelMuted: isDark ? 'text-slate-400' : 'text-slate-500',
      navMuted: isDark ? 'text-slate-300 hover:bg-white/6 hover:text-sky-300' : 'text-slate-600 hover:bg-sky-50 hover:text-sky-700',
      navActive: isDark
