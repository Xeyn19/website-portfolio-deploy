      ...
      >
        <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
          <div className="px-6 py-7 sm:px-8 lg:px-10">
            ...
            font-semibold leading-tight tracking-tight sm:min-h-[168px] max-md:text-3xl max-sm:text-[24px]">
            ...
            <div className={`-mt-5 max-sm:-mt-12 rounded-[28px] p-5 ${classes.panelSoft}`}>
              <p className={`text-xs font-semibold uppercase tracking-[0.32em] ${classes.label}`}>
                About Me
              </p>
            ...
            <div className="mt-4">
              <div className={`rounded-[24px] p-5 ${classes.panelDark}`}>
              ...
              <div className="mt-3 flex flex-wrap gap-3">
                {socialLinks.map((item, index) => (
                  <motion.a
                    ...
                    className={`flex items-center gap-3 rounded-full px-4 py-2 transition ${classes.socialPill}`}
                  >
                    <img src={item.img} alt={item.label} className="h-6 w-6 object-contain" />
                    <span className={`text-sm font-medium ${classes.socialText}`}>{item.label}</span>
                  </motion.a>
                ))}
              </div>
            </div>
          ...
          <div className={`relative overflow-hidden px-7 py-7 text-white ${classes.panelDark}`}>
            ...
            <div className="relative flex h-full flex-col gap-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                ...
                <div className={`rounded-[24px] p-5 sm:col-span-2 lg:col-span-1 ${classes.darkTile}`}>
                  <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-400">
                    What I Bring
                  </p>
                  <p className="mt-2 text-sm leading-6 text-slate-300">
